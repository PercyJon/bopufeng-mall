...
public class DistributedIdWorker {
	...
	private static final Logger logger = LoggerFactory.getLogger(DistributedIdWorker.class);
	...
	private static long getServerIdAsLong() {
		try {
			String hostname = DistributeConfiguration.getInstance().getValue("hostName");
			;
